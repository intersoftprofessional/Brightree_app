                    ...
                    if((isset($_POST['action']) && $_POST['action'] == 'edit') || $id != '' )
                    {
                        if((isset($_POST['list_id']) && $list['list_id'] == $_POST['list_id']) || ($id != '' && $list['list_id'] == $id))
                        {
                            ...
                            if(!empty($offers))
                            {
                                ...
                                {
                                    $offers1[$offer['list_id']][$offer['retailer_id']]['offer'] = $offer['offer'];
                                    $offers1[$offer['list_id']][$offer['retailer_id']]['set_homepage'] = $offer['set_homepage'];
                                    $offers1[$offer['list_id']][$offer['retailer_id']]['order'] = $offer['order'];
                                }
