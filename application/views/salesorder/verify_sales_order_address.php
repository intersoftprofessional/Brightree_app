...
<div id="processing" class="nNote" style="display:none;"><img src="<?php echo base_url(); ?>theme/sos/images/processing_dots.gif"/></div>
								...
								<div class="widget acc first">      
									...
									<div class="widget">
										<div class="head inactive">
											<h5>
												Verify & Update Sales Order's Delivery Address 
											</h5>
										</div>
										<div class="body">
											<form id="valid" name="verify_sales_order_address" action="<?php echo site_url('salesorder/verify_sales_order_address'); ?>" method="post" class="mainForm" >
												<div class="rowElem">                                                
													<div class="rowElem">
														<label>Sales Order Created From</label>
														<div class="formRight">
														<input type="text" value="" name="CreateDateTimeStart" placeholder="Click to select a date" id="date1" class="validate[required]" />														
														</div>
													</div>	
													<div class="rowElem">
														<label>Sales Order Created Till</label>
														<div class="formRight">
													...
													<div class="live-formRight">
														<input type="submit" class="greyishBtn" value="Verify & Update Sales Order's Delivery Address" />
													</div>
												</div>
											</form>
										</div>
					...
					<div class="table">
						<div class="head"><h5 class="iFrames">Verify & Update Sales Order's Delivery Address Requests</h5></div>
						<table cellpadding="0" cellspacing="0" border="0" class="display" id="dataexample">
							<thead>
								<tr>
									<!--<th width="15%">Retailer member number</th>-->									
									<th width="20%">Date & Time</th>
									<th width="20%">Sales Order create start date</th>
									<th width="20%">Sales Order create end date</th>
									<th width="10%">Total Sales-Orders</th>
									<th width="10%">Updated Sales-Orders</th>
							...
							<?php $li = 0; foreach($beans as $bean) { ?>
								<tr class="gradeA">
									...
									<td><?php echo $bean['sales_order_create_start_date']; ?></td>
									<td><?php echo $bean['sales_order_create_end_date']; ?></td>
									<td><?php echo $bean['total_sales_orders']; ?></td>
									<td><?php echo $bean['sales_orders_updated']; ?></td>
									<td class="center"><div class="num">
										<a href="<?php echo site_url('salesorder/list_affected_sales_orders_by_api/'.$bean['ID']); ?>" title="View Results" class="greenNum">
										<img alt="" src="<?php echo base_url(); ?>theme/sos/images/view_icon.png">
										</a><input type="hidden" value="<?php echo site_url('salesorder/delete_sales_order_api_request/'.$bean['ID']); ?>" id="link_del_<?php echo $li; ?>"/>
