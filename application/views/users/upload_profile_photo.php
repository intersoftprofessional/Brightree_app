...
<div class="wrapper">
    ...
    <div class="content" id="page_title">
        ...
        <div class="fluid">
            <div class="span8">
                    ...
                    <div class="widget">
                        <div class="head inactive"><h5>Upload main profile photo</h5></div>
                        <div class="body">
                           <div class="rowElem">
                               ...
                               <div id="dropArea">Drag and drop your profile image here. The image must be landscape (not portrait) and at lease 630px wide</div>
                               <div class="info">
    ...
    <!-- Gallery -->
    <?php if(isset($bean['main_profile_image']) && $bean['main_profile_image'] != '')
          {
    ...
    <div class="span8">
      <div class="widget first">
          <div class="head"><h5 class="iPreview">Main profile photo gallery</h5></div>
          <div class="pics">
                ...
                <div id="galleryListWrapper">
                    <?php if (!empty($beans['images']) && count($beans['images']) > 0) { ?>
                          ...
                          <ul id="galleryList" class="clearfix">
                              ...
                              ?>
                                  <li>
                                      <div class="radio-pos"><input type="hidden" value="profile" name="type" /><input type="radio" name="main_profile_image" value="<?php echo $main_image; ?>" <?php if(isset($main_image)) if($main_image == $act_image) echo "checked='checked'"; ?> /></div>
                                      <div class="del_del_img">
                                          ...
                                          <a href="<?php echo base_url().$image['file_path']; ?>" title="<?php echo $image['file_title']; ?>" class="cboxElement" rel="colorbox"><img src="<?php echo base_url().$image['thumb_path']; ?>" alt="<?php echo $image['file_title']; ?>"/></a>
  ...
  <script type="text/javascript">
    ...
    function close_btn(id)
    {
        ...
        else
        {
            ...
            type: "POST",
            data: { "page":page,"small":small,"big":big},
