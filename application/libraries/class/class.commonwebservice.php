...
Class CommonWebService {
	...
	*/
	...
	function TaxZoneFetchAll()
	{
		$SOAPAction="http://www.brightree.com/external/ReferenceDataService/IReferenceDataService/TaxZoneFetchAll";
		$specific_post_string='<TaxZoneFetchAll xmlns="http://www.brightree.com/external/ReferenceDataService">                                   
                                </TaxZoneFetchAll>';
